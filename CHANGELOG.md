...
## [v0.11.16](https://github.com/hackspaces/blueshark-forge/releases/tag/v0.11.16) — remove forge company and forge roster; refocus on the harness kernel

*2026-07-20 · `pip install blueshark-forge==0.11.16`*

See the release commit for details.

## [v0.11.15](https://github.com/hackspaces/blueshark-forge/releases/tag/v0.11.15) — git is harness-managed: run in any folder, verified work auto-applies, a starter company after setup

*2026-07-20 · `pip install blueshark-forge==0.11.15`*

See the release commit for details.

## [v0.11.14](https://github.com/hackspaces/blueshark-forge/releases/tag/v0.11.14) — the company TUI: an animated office, live board, and a receipts ticker where a rejected done-claim shows on screen

*2026-07-19 · `pip install blueshark-forge==0.11.14`*
...
## [v0.11.9](https://github.com/hackspaces/blueshark-forge/releases/tag/v0.11.9) — forge team (the first swarm slice) + every session logs its exact system prompt

*2026-07-19 · `pip install blueshark-forge==0.11.9`*

See the release commit for details.

## [v0.11.8](https://github.com/hackspaces/blueshark-forge/releases/tag/v0.11.8) — MCP: any MCP server’s tools become grammar-forced forge actions a small model can call

*2026-07-19 · `pip install blueshark-forge==0.11.8`*

See the release commit for details.

## [v0.11.7](https://github.com/hackspaces/blueshark-forge/releases/tag/v0.11.7) — forge is frozen-binary ready (autopilot re-invokes correctly when packaged as a standalone executable)

*2026-07-19 · `pip install blueshark-forge==0.11.7`*
